class Nyym < ActiveRecord::Base
  ...
  validates_format_of :phone_number, :message => "must be a valid telephone number.", :with => lambda{ |nyym| nyym.phone_number.nil? ? true : /^[\(\)0-9\- \+\.]{10,20} *[extension\.]{0,9} *[0-9]{0,5}$/i } 
